...
class GetPredictResponseModel extends Equatable {
  const GetPredictResponseModel({
  ...
  factory GetPredictResponseModel.fromJson(Map<String, dynamic> json) =>
      GetPredictResponseModel(
